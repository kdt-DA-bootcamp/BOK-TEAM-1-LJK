...
class DebentureSpider(scrapy.Spider):
    ...
    start_urls = [
        'https://finance.naver.com/research/debenture_list.naver?keyword=&brokerCode=&searchType=writeDate&writeFromDate=2008-01-01&writeToDate=2024-11-30&x=32&y=22&page=1'
    ]
